/**
 * GitHub API client — replaces git CLI for branch/PR operations
 */
...
/** Parse "https://github.com/org/repo.git" → { owner: "org", repo: "repo" } */
...
export async function listBranches(
  ...
  // Get open PRs to match with branches
  ...
  for (const branch of branches) {
    ...
    // Compare with main for ahead/behind
    let aheadBy = 0;
    let behindBy = 0;
    try {
