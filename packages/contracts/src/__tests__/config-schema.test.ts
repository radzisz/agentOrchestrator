...
import type { ConfigField, ProviderTypeSchema, ProviderCategory } from "../config-schema.js";
...
describe("ProviderTypeSchema", () => {
  it("has all required properties", () => {
    const schema: ProviderTypeSchema = {
      type: "test-provider",
      category: "tracker",
  ...
  it("supports all provider categories", () => {
    const categories: ProviderCategory[] = ["tracker", "im", "scm", "ai"];
